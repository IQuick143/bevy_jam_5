...
#[require(CylClickable, CylWidget)]
...
#[derive(Component)]
#[require(CylNavigator {
	axis_split: AxisSplit::default(),
	up_navigation_tactic: CylUpNavigationTactic::SubnavigateCapture(SubnavigationMode::SubNavigateCapture),
	down_widget: None,
	avoid_implicitly_changing_down_widget: true
}, CylWidget)]
...
#[require(CylNavigator {
	axis_split: AxisSplit::default(),
	up_navigation_tactic: CylUpNavigationTactic::SubnavigateCapture(SubnavigationMode::SubNavigatePropagate),
	down_widget: None,
	avoid_implicitly_changing_down_widget: true
}, CylButton)]
...
fn submenuselector_constructor(
	...
	wrapping: bool,
	_allow_subnavigation_events_from_submenus: bool,
