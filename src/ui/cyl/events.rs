...
/// Cyl [`Event`] describing an interaction happening, represents something like a button press, checkbox toggle, or confirmation.
...
pub struct CylSelect {
	...
	pub selector: Entity,
	pub value: i64,
	/// Whether this value should be used as a relative offset (false) or directly set the absolute value (true)
	pub absolute: bool,
}
