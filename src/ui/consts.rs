...
pub const LEVEL_COMPLETED_MARKER_SIZE_PX: f32 = 30.0;
pub const LEVEL_COMPLETED_MARKER_SIZE: Val = Px(LEVEL_COMPLETED_MARKER_SIZE_PX);
pub const LEVEL_COMPLETED_MARKER_MARGIN_PX: f32 = 7.5;
pub const LEVEL_COMPLETED_MARKER_MARGIN: Val = Px(LEVEL_COMPLETED_MARKER_MARGIN_PX);
pub const GRID_BUTTON_PADDING: UiRect = UiRect::horizontal(Px(
