...
pub const FEEDBACK_FORM_PADDING: UiRect = UiRect::all(COMMON_GAP).with_top(Val::Px(5.0));
...
pub const STAR_LABEL_WIDTH: Val = Val::Px(100.0);
pub const STAR_LABEL_TEXT_SIZE: f32 = 18.0;
pub const INPUT_TEXT_SIZE: f32 = 18.0;
pub const INPUT_LINE_HEIGHT: f32 = 1.2;
