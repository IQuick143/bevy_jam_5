...
impl ColorKey {
	fn palette_sheet_position(self) -> Option<UVec2> {
		match self {
			...
			// Interactive UI grid
			ColorKey::NextLevelButton => Some(UVec2::new(0, 2)),
			ColorKey::NextLevelButtonHovered => Some(UVec2::new(1, 2)),
			ColorKey::NextLevelButtonPressed => Some(UVec2::new(2, 2)),
			ColorKey::CycleReady => Some(UVec2::new(0, 3)),
			ColorKey::CycleTrigger => Some(UVec2::new(1, 3)),
			ColorKey::CycleDisabled => Some(UVec2::new(3, 3)),
			ColorKey::CycleCentralArrow => Some(UVec2::new(4, 3)),
			ColorKey::CycleRingsReady => Some(UVec2::new(0, 4)),
			ColorKey::CycleRingsSelect => Some(UVec2::new(1, 4)),
			ColorKey::CycleRingsDisabled => Some(UVec2::new(3, 4)),
			ColorKey::CycleRingOutlines => Some(UVec2::new(0, 5)),
			ColorKey::CycleRingOutlinesDisabled => Some(UVec2::new(3, 5)),
			ColorKey::CycleHitboxes => Some(UVec2::new(4, 5)),
			ColorKey::NodeBackground => Some(UVec2::new(0, 6)),
			ColorKey::UiButtonHovered => Some(UVec2::new(1, 6)),
			ColorKey::UiButtonPressed => Some(UVec2::new(2, 6)),
			ColorKey::UiButtonDisabled => Some(UVec2::new(3, 6)),
			ColorKey::NewLevelButton => Some(UVec2::new(4, 6)),
			ColorKey::SpriteButton => Some(UVec2::new(0, 7)),
			ColorKey::SpriteButtonHovered => Some(UVec2::new(1, 7)),
			ColorKey::SpriteButtonPressed => Some(UVec2::new(2, 7)),
			ColorKey::SpriteButtonDisabled => Some(UVec2::new(3, 7)),
			ColorKey::SliderFill => Some(UVec2::new(0, 8)),
			ColorKey::SliderHoveredFill => Some(UVec2::new(1, 8)),
			ColorKey::SliderPressedFill => Some(UVec2::new(2, 8)),
			ColorKey::SliderDisabledFill => Some(UVec2::new(3, 8)),
			ColorKey::SliderOutline => Some(UVec2::new(0, 9)),
			// Misc UI
			ColorKey::Checkmark => Some(UVec2::new(6, 2)),
			ColorKey::WarningSign => Some(UVec2::new(7, 2)),
			ColorKey::InvertedLinkMultiplicityLabel => Some(UVec2::new(8, 2)),
			ColorKey::LinkLines => Some(UVec2::new(7, 3)),
			ColorKey::LinkMultiplicityLabel => Some(UVec2::new(8, 3)),
			ColorKey::UiLabelText => Some(UVec2::new(6, 4)),
			ColorKey::HeaderText => Some(UVec2::new(7, 4)),
			ColorKey::UiButtonText => Some(UVec2::new(8, 4)),
			// Background
			ColorKey::BackgroundBase => Some(UVec2::new(7, 6)),
			ColorKey::BackgroundDetail => Some(UVec2::new(8, 6)),
			ColorKey::BackgroundSolvedBase => Some(UVec2::new(7, 7)),
			ColorKey::BackgroundSolvedDetail => Some(UVec2::new(8, 7)),
			// Unmapped
			ColorKey::Blank => None,
			#[cfg(feature = "playtest")]
